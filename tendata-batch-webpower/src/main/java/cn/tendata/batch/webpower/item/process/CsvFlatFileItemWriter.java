...
public class CsvFlatFileItemWriter<T> extends AbstractItemStreamItemWriter<T> implements
    ResourceAwareItemWriterItemStream<T>,
    InitializingBean {

    private static final boolean DEFAULT_TRANSACTIONAL = true;

    protected static final Log logger = LogFactory.getLog(CsvFlatFileItemWriter.class);
    ...
    public CsvFlatFileItemWriter() {
        this.setExecutionContextName(ClassUtils.getShortName(CsvFlatFileItemWriter.class));
    }
