...
import cn.tendata.batch.webpower.item.CsvItemRecordLineHandler;
...
public class CsvFlatFileItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements
    ResourceAwareItemReaderItemStream<T>, InitializingBean {

    private static final Log logger = LogFactory.getLog(CsvFlatFileItemReader.class);

    // default encoding for input files
    public static final String DEFAULT_CHARSET = Charset.defaultCharset().name();

    private CsvItemRecordLineHandler csvItemRecordLineHandler;
    ...
    public CsvFlatFileItemReader() {
        setName(ClassUtils.getShortName(CsvFlatFileItemReader.class));
    }

    public void setCsvItemRecordLineHandler(CsvItemRecordLineHandler csvItemRecordLineHandler) {
        this.csvItemRecordLineHandler = csvItemRecordLineHandler;
    }
    ...
    protected T doRead() throws Exception {
        ...
        if (line == null) {
            ...
            try {
                line = csvItemRecordLineHandler.handle(line); // 处理line 中引号未转义的地方
